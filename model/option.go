...
func InitOptionMap() {
	...
	common.OptionMap["CustomerSelfRegisterEnabled"] = strconv.FormatBool(common.CustomerSelfRegisterEnabled)
	...
	common.OptionMap["FeedbackUrl"] = common.FeedbackUrl
	common.OptionMap["SystemName"] = common.SystemName
	common.OptionMap["Logo"] = common.Logo
	common.OptionMap["ServerAddress"] = system_setting.ServerAddress
	common.OptionMap["PublicApiAddress"] = system_setting.PublicApiAddress
...
func updateOptionMap(key string, value string) (err error) {
	...
	if strings.HasSuffix(key, "Enabled") || key == "DefaultCollapseSidebar" || key == "DefaultUseAutoGroup" || key == "SMTPForceAuthLogin" || key == "SMTPInsecureSkipVerify" {
		...
		case "CustomerSelfRegisterEnabled":
			common.CustomerSelfRegisterEnabled = boolValue
	...
	case "PublicApiAddress":
		system_setting.PublicApiAddress = value
	case "WorkerUrl":

...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/check-email", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.CheckEmail)
			userRoute.POST("/check-username", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.CheckUsername)
			userRoute.POST("/check-verification-code", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, controller.CheckVerificationCode)
			userRoute.POST("/login/precheck", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, controller.LoginPrecheck)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.PUT("/plans/:id/status", controller.AdminUpdateSubscriptionPlanStatus)
